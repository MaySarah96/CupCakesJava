...
public class Commande  {
    ...
    public Commande(Date dateCmd, Double montantCmd, Date dateLivCmd, String addLiv, String etatLivCmd, String etatCmd, Utilisateur idUser) {
        this.dateCmd = dateCmd;
        this.montantCmd = montantCmd;
        this.dateLivCmd = dateLivCmd;
        this.addLiv = addLiv;
    ...
    public Commande(Integer idCmd, Date dateCmd, Double montantCmd, Date dateLivCmd, String addLiv, String etatLivCmd, String etatCmd, Utilisateur idUser) {
        this.idCmd = idCmd;
        this.dateCmd = dateCmd;
        this.montantCmd = montantCmd;
        this.dateLivCmd = dateLivCmd;
